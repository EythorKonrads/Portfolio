(function() {
    ...
    var sliderCanvas = document.querySelector('.gallery__canvas');
    var imagesEl = [].slice.call(document.querySelectorAll('.gallery__image'));
    var textEl = [].slice.call(document.querySelectorAll('.gallery__text'));
    ...
    function initEvents() {
        ...
        document.querySelector('.gallery__button--prev').addEventListener('click', prevItem);
        document.querySelector('.gallery__button--next').addEventListener('click', nextItem);
    ...
    function resizeStart() {
        if (initial) {
            ...
            sliderCanvas.classList.add('gallery__canvas--hidden');
        }
    ...
    function resizeEnd() {
        ...
        hideTimer = setTimeout(() => {
            sliderCanvas.classList.remove('gallery__canvas--hidden');
        }, 500);
    }
})();
